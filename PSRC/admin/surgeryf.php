   ...
   <div class="container">
      ...
      <div class="content">
         <div class="form-container" style="border: 1px solid black;">
          ...
          <form action="surgeryf.php" method="post">
    <h3>SURGERY FEEDBACK</h3>
    <table>
        <tr>
            <th>ID</th>
            <th>Surgery Type</th>
        ...
        <?php
            $sql = "SELECT id,surtype, caregiver, adate, message FROM surgery";
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    echo "<tr>
                            ...
                            <td>".$row["message"]."</td>
                            <td>
                                <button name='delete' type='submit' value='".$row["id"]."' onclick='return confirm(\"Are you sure you want to delete this feedback?\")'>Delete</button>
                            </td>
                          </tr>";
                }
            } else {
